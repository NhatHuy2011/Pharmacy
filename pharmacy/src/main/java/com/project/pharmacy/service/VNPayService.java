...
public class VNPayService {
    ...
    @NonFinal
    @Value("${vnpay.vnp_ReturnUrlWeb}")
    protected String vnp_ReturnUrlWeb;

    @NonFinal
    @Value("${vnpay.vnp_ReturnUrlAndroid}")
    protected String vnp_ReturnUrlAndroid;
    ...
    public String createPaymentVNPayWeb(HttpServletRequest req){
        ...
        vnp_Params.put("vnp_ReturnUrl", vnp_ReturnUrlWeb);
    ...
    public void callBackWeb(String responseCode, String orderId){
    ...
    //ANDROID
    public String createPaymentVNPayAndroid(HttpServletRequest req){
        long amount = getAmount(req.getParameter("orderId")) * 100L;
        ...
        vnp_Params.put("vnp_OrderInfo", "Thanh toan don hang:" + req.getParameter("orderId"));
        vnp_Params.put("vnp_OrderType", "other");
        vnp_Params.put("vnp_ReturnUrl", vnp_ReturnUrlAndroid);
        vnp_Params.put("vnp_IpAddr", vnp_IpAddr);
    ...
    public void callBackAndroid(String responseCode, String orderId){
        Orders orders = orderRepository.findById(orderId)
                .orElseThrow(() -> new AppException(ErrorCode.ORDER_NOT_FOUND));
