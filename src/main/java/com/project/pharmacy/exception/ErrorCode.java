...
public enum ErrorCode {
    ...
    // Price exception
    PRICE_NOT_NEGATIVE("Vui lòng không nhập số âm", 400, HttpStatus.BAD_REQUEST),
    PRICE_OVER_QUANTITY("Số lượng hàng trong kho vượt mức cho phép", 400, HttpStatus.BAD_REQUEST),
